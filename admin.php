    ...
    if ($result->num_rows > 0) {
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        echo "<td class='TABEL'><form method='post' action='update.php' class='updateform'>
                ...
                <input type='image' src='Bilder/check-svgrepo-com.svg'  alt='Submit' name='submit3' value='Oppdater' id='' class='oppdaterbtn'
                style='width: auto; height: 20px border-color: black; border-radius: 10px; border-width: 2px; border-radius: 8px;'/>
                </form></td>";
        echo "</tr>";
