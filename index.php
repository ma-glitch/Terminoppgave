...
<body onload="close()">
    <ul class="topnav">
        <li><a href="index.php"><img src="house-03-svgrepo-com.svg" class="menyicon"></a></li>
        <li><a href="leggtil.php"><img src="file-add-svgrepo-com.svg"class="menyicon"></a></li>
        <li><a href="profil.php"><img src="user-01-svgrepo-com.svg" class="menyicon"></a></li> 
        <?php if (($_SESSION["admin"] == "yes")) {
            echo "<li><a href='admin.php'><img src='file-edit-svgrepo-com.svg' class='menyicon'></a></li>";
        }
        ?>
    </ul>
